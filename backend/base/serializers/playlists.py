...
class PlaylistsByProfileSerializer(serializers.Serializer):
    ...
    creator_profile_id = serializers.UUIDField(source='playlist.profile.profile_id', read_only=True)
    creator_profile_type = serializers.CharField(source='playlist.profile.profile_type', read_only=True)
    creator_profile_privacy = serializers.CharField(source='playlist.profile.profile_privacy', read_only=True)
    creator_profile_name = serializers.CharField(source='playlist.profile.profile_name', read_only=True)
    creator_profile_handle = serializers.CharField(source='playlist.profile.profile_handle', read_only=True)
    creator_profile_picture = serializers.CharField(source='playlist.profile.profile_picture', read_only=True)
